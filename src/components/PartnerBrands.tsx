...
const partnerLogo = "https://i.postimg.cc/yNzMGFKm/download-1-removebg-preview.png";

// Duplicate the logo 10 times for the marquee effect
const partners = Array(10).fill({ logo: partnerLogo, name: "Partner Brand" });
